...
#В приведенном фрагменте программа принимает ввод пользователя и сопоставляет первое слово с командой в verb_dict. При совпадения вызывается соответствующая функция.
...
#Класс Goblin, наследуется от класса GameObjects. Функция examine, возвращает описание объектов.
